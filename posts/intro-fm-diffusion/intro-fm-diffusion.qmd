...
The [accompanying code](https://github.com/nbrosse/introduction-flow-matching-diffusion) is on GitHub, and the experiment lives in a single [notebook](https://github.com/nbrosse/introduction-flow-matching-diffusion/blob/main/notebooks/marginal_velocity_decomposition_and_posterior_mcmc.ipynb).
...
The [notebook](https://github.com/nbrosse/introduction-flow-matching-diffusion/blob/main/notebooks/marginal_velocity_decomposition_and_posterior_mcmc.ipynb) fixes the following setup:
