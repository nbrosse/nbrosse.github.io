...
The [accompanying code](https://github.com/nbrosse/introduction-flow-matching-diffusion) is on GitHub, and the experiment lives in a single [notebook](https://github.com/nbrosse/introduction-flow-matching-diffusion/blob/main/notebooks/posterior_averaging.ipynb).
...
The [notebook](https://github.com/nbrosse/introduction-flow-matching-diffusion/blob/main/notebooks/posterior_averaging.ipynb) fixes the following setup:
