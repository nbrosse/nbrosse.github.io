...
Before starting the application, ensure you have followed the setup instructions in the [project's README](https://github.com/nbrosse/llm-observability). Make sure the Langfuse Docker container is up and running.
