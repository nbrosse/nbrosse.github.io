...
The [accompanying code](https://github.com/nbrosse/introduction-flow-matching-diffusion) is on GitHub, and the checks reproduced below live in a single [notebook](https://github.com/nbrosse/introduction-flow-matching-diffusion/blob/main/notebooks/posterior_concentration.ipynb). It shares a repository with the notebook behind the companion post [Flow matching as posterior averaging](https://nbrosse.github.io/posts/intro-fm-diffusion/intro-fm-diffusion.html).
