...
This section provides a rigorous analysis of the collapse phenomenon in Flow Matching using tools from statistical physics, specifically the Random Energy Model (REM) and Large Deviation Principles (LDP).
